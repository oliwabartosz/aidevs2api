...
md2html_system = """Convert the Markdown to HTML. Return nested tags in one line. Treat <strong> as <b>,
<em> as <u>:"""
md2html_human = """"""
...
prompt = ChatPromptTemplate(
    messages=[
        ...
        HumanMessagePromptTemplate.from_template(f"{md2html_human}" + "{question}")
    ]
)
